...
Out workflow will look something like this (file names ):
...
In addition to vcfR, we'll learn to use the ``qqman` package (already installed!) for making mahattan plots today!