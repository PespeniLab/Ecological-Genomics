...
revigo_input <- filtered_GO_results[, c("GO.ID", "weightFisher")]

# Rename columns for clarity
colnames(revigo_input) <- c("GO.ID", "pValue")

# Optionally, save to CSV for upload to REVIGO
write.csv(revigo_input, file = "topGO_for_REVIGO.csv", row.names = FALSE)
```