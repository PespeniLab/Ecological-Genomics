...
##Let's make a Euler plot of shared differentially expressed genes between CvsT across generations
Identify the DEGs in the contrast for control versus treatment for each generation
```
#Gen1
resG1_CvT <- results(dds, contrast=c("group","controlG1","treatmentG1"), alpha = 0.05)
